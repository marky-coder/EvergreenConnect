    ...
    <section id="about" className="py-16 md:py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4 text-base md:text-lg">
              <Reveal direction="up" delay={0.06}>
                <p className="text-foreground">
                  Here at Evergreen, we love bringing beauty to our community! We are a small,
                  local company eager to connect home and land owners with solutions to their problems and
          ...
          <Reveal direction="right" delay={0.12} className="flex items-center justify-center p-8">
            <img
              src={evergreenLogo}
